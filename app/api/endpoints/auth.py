...
from app.schemas.auth_schema import AccessTokenResponse, LoginRequest, RefreshRequest, RegisterRequest, TokenResponse, UserResponse
from app.services.auth_service import create_user, get_user_by_username, verify_password
...
def refresh(body: RefreshRequest, db: Session = Depends(get_db)):
    ...
    # DB에 저장된 토큰과 일치하는지 확인 (로그아웃된 토큰 또는 탈취 토큰 차단)
